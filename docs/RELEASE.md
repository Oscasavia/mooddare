...
- Android opens directly into a camera with floating controls and a repeating lens wheel. Default 9:16 framing can be changed to 3:4 or Full; the viewfinder and saved photo/video share the chosen ratio. Tap for a photo, hold/release for video, slide up to lock, tap to stop. Strength/comparison controls appear on demand. Camera startup error/retry states, front camera default, lifecycle cleanup and the native 30-second limit remain.
