...
- Android opens directly into a full-screen camera with floating controls and a repeating lens wheel. Tap for a photo, hold/release for video, slide up to lock, tap to stop. Strength/comparison controls appear on demand. Camera startup error/retry states, front camera default, lifecycle cleanup and the native 30-second limit remain.
