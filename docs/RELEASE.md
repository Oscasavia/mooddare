...
- Capture review emphasizes the media and Post action. Photo adjustments open on demand with a repeating icon wheel, selected-effect label, one slider at a time, reset and comparison; Save/Share live in an overflow menu. Video review has accessible play/pause and scrubbing.
